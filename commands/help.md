---
description: Guide for using Team-Shinchan plugin
---

# Help Command

Shows help and usage guide for Team-Shinchan plugin.

See `skills/help/SKILL.md` for full documentation.
...
- `/team-shinchan:plan` - Strategic planning
